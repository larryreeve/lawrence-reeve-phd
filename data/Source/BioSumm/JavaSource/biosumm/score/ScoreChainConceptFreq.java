...
public class ScoreChainConceptFreq
	implements IScorer
{
		...
		throws Exception
	{
		...
		System.out.println("\tScoreChainConceptFreq: useAllStrongChainConcepts=" + useAllStrongChainConcepts);
		
		
		// Set initial sentence score
